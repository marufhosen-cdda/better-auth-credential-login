...
// Generate machine-specific key focusing only on hardware characteristics
function generateMachineKey(): string {
    const deviceInfo = collectDeviceInfo();

    // Use only the most reliable hardware characteristics
    ...
    return `hardware:${coreCharacteristics}`;
}
